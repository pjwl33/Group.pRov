function instrument(type) {
  ...
  if (type == 'piano') {
    ...
    soundFiles = [{key: 65, sound:'Kicks/Bmb_K.wav'}, {key: 83, sound:'Kicks/Bnc_K.wav'}, {key: 68, sound:'Kicks/Bnk_K.wav'}, {key: 70, sound:'Kicks/Bnk_K1.wav'}, {key: 71, sound:'Kicks/Brk_K1.wav'}, {key: 72, sound:'Kicks/Bub_K.wav'}, {key: 74, sound:'Snares/Aco_Snr.wav'}, {key: 75, sound:'Snares/Acu_Snr.wav'}, {key: 76, sound:'Snares/Blk_Snr.wav'}, {key: 87, sound:'Cymbols/CL_OHH1.wav'}, {key: 69, sound:'Cymbols/Hi_Crsh.wav'}, {key: 84, sound:'Cymbols/Lo_Crsh.wav'}, {key: 89, sound:'HiHats/Ac_H.wav'}, {key: 85, sound:'HiHats/Aki_H1.wav'}, {key: 79, sound:'Cymbols/Rev_Crsh.wav'}, {key: 80, sound:'Snares/Box_Snr2.wav'}];
  }
